    ...
    (() => {
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            function mask(event) {
                ...
                var i = 0;
                var val = this.value.replace(/\D/g, "").replace(/^8/, "7").replace(/^1/, "71").replace(/^2/, "72").replace(/^3/, "73").replace(/^4/, "74").replace(/^5/, "75").replace(/^6/, "76").replace(/^9/, "79");
                ...
                } else setCursorPosition(this, this.value.length);
                if (this.value.length < 18 && this.value.length >= 2) input.setCustomValidity(`Минимальное количество символов: 11. Длина текста сейчас ${val.length}`); else {
        ...
        function initSliders() {
            if (document.querySelector(".swiper")) {
                ...
                new core(".company-about-page__slider", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 3,
